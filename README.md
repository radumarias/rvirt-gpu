...
**The advantage is your private data never leave your network in plain. Only data needed to run actual CUDA instructions are sent over the wire but encrypted with TLS.**
